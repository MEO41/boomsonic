...
| **ross-rotordynamics** 2.3.0 (`.venv`, PyPI, MIT) | installed. Verified against the simply supported shaft, the Jeffcott rotor and an overhung gyroscopic disc (errors of 0.0001-0.20 %). Needs two import work-arounds for plotly 7 and numba 0.67 (`ross_shim.py`); these do not touch the FE matrices | rotor critical speeds, Campbell diagram, damped AF (`docs/phase4_rotordynamics.md`) |
