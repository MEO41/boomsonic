...
Plots: `plots/phase4_critical_speed_map.png`, `phase4_campbell.png`, `phase4_rotor_modes.png`.
Data: `data/phase4_rotordynamics.json`, `_critmap.csv`.
...
**Stiffening sweep** (`rotordynamics_stiffening.py`, `plots/phase4_rotor_stiffening.png`): layout A,
...
## 5. Damped assessment (`rotordynamics_damped.py`, `data/phase4_rotordynamics_damped.csv`, `plots/phase4_rotor_damped_AF.png`)
