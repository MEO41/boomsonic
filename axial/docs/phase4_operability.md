...
`axial/plots/phase4_operability.png`.
...
### 2.1 Fixed geometry (`axial/data/phase4_running_line_ax0_opr5_t1150_cap_blk_nw1.csv`)
...
### 2.2 Remedies (SLS; `axial/data/phase4_nozzle_sweep_*.csv`, `phase4_bleed_sweep_*.csv`, `phase4/vigv_*.json`)
...
* **Rotordynamics interaction** (`axial/docs/phase4_rotordynamics.md`): that study assumed idle at 35 %.
