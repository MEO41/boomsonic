...
# axial results live under axial/data/; the P400 benchmark stayed in the shared data/
D = lambda f: pd.read_csv(os.path.join(AXROOT if os.path.exists(os.path.join(AXROOT, "data", f)) else ROOT, "data", f))
...
fig.tight_layout(); fig.savefig(os.path.join(AXROOT, "plots", "phase4_optionB_operability.png"), dpi=130); print("saved")
