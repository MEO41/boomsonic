...
rows = []
for tag, opr in (("ce85000_opr4_t1150", 4.0), ("ax0_opr5_t1150_cap", 5.0)):
    at.OPR = opr
...
df = pd.DataFrame(rows); df.to_csv(os.path.join(ROOT, "data", "phase3_efficiency_sensitivity.csv"), index=False)
